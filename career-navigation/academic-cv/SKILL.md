---
name: ors-career-navigation-academic-cv
display_name: "Academic CV (US/EU Faculty/Postdoc)"
...
tags: [cv, academic, faculty, postdoc, biosketch, mentoring]
difficulty: intermediate
prerequisites:
  tools: [latex, markdown, pandoc]
  skills: []
sources_consulted:
  - "NSF PAPPG 24-1 (Proposal & Award Policies & Procedures Guide) for biosketch structure"
  - "NIH Biosketch Format Page (NOT-OD-15-032 and subsequent updates)"
  - "University of California, Berkeley Office of Faculty Affairs CV guidance"
  - "Stanford University School of Medicine faculty CV guidance"
  - "Hirsch JE (2005) 'An index to quantify an individual's scientific research output' PNAS"
...
2. Education
3. Professional appointments / positions
4. Publications
...
9. Invited talks
10. Software, datasets, and code releases
...
5. Supervision of students and postdocs
6. Teaching activities
7. Publications (often first in some German forms)
8. Invited talks
...
- Workflows or pipelines (Nextflow, Snakemake, CWL) — cross-reference relevant `ors-*` skills.
...
- `ors-research-grants-nsf-standard` — NSF proposal structure (mentoring plan, broader impacts)
