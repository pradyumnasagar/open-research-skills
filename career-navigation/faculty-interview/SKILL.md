---
name: ors-career-navigation-faculty-interview
display_name: "Academic Faculty Job Interview"
...
tags: [faculty, interview, job-talk, chalk-talk, negotiation, start-up]
difficulty: advanced
prerequisites:
  tools: [latex, beamer, keynote, google-slides]
  skills: [ors-career-navigation-academic-cv, ors-career-navigation-negotiation]
sources_consulted:
  - "MIT, Stanford, and UC Berkeley faculty search committee handbooks (publicly available)"
  - "AAUP standards on academic hiring"
  - "Nature Careers 'Futures' column on academic interviewing"
  - "Science Careers 'Interviewing for an Academic Job' article series"
  - "Hertz Foundation interview preparation guidance (publicly available)"
  - "Public university policies on dual-career accommodation (published on institutional HR pages)"
