---
name: ors-career-navigation-negotiation
display_name: "Salary and Package Negotiation"
...
tags: [negotiation, salary, start-up, batna, equity, dual-career, counter-offer]
difficulty: advanced
prerequisites:
  tools: [markdown, latex, pandoc, spreadsheet]
  skills: [ors-career-navigation-faculty-interview, ors-career-navigation-industry-transition]
sources_consulted:
  - "Fisher R, Ury W, Patton B. 'Getting to Yes' (3rd ed., 2011) — BATNA, interests vs positions, objective criteria"
  - "Mnookin R, Peppet S, Tulumello A. 'Beyond Winning' — negotiation in the legal and behavioral-economics tradition"
  - "Voss C, Raz T. 'Never Split the Difference' — tactical empathy, labeling, mirroring"
  - "Babcock L, Laschever S. 'Women Don't Ask' — gender and negotiation"
  - "Shell GR. 'Bargaining for Advantage' — negotiation strategies and styles"
  - "BLS Occupational Employment Statistics (public wage data by occupation and metro area)"
  - "Levels.fyi public compensation methodology"
  - "AAUP salary surveys and institutional data (public summaries)"
...
- Pre-offer "what are you expecting?" conversations where you have no offer in hand — see `ors-career-navigation-faculty-interview` for how to handle these in the interview context.
- Resolving a dispute with a current employer (e.g., a raise conversation at a current job) — overlaps but the power dynamics are different; the BATNA is weaker.
...
- A clear BATNA (best alternative to a negotiated agreement) — for most researchers, this is the next-best offer, a current position, or a postdoc.
...
1. **Separate the people from the problem.** The negotiation is about the offer, not about you as a person. Stay professional; do not take pushback personally.
2. **Focus on interests, not positions.** A position is "I want a $50k raise". An interest is "I want to feel that this role recognizes my seniority and the cost of living in this city". Positions can be reconciled only by compromise; interests can be met by multiple means.
3. **Invent options for mutual gain.** The goal is to find a package that solves the other side's problem (e.g., "we need a faculty member with this expertise") and yours.
4. **Insist on objective criteria.** Anchor asks in data: BLS wage data, AAUP salary surveys by rank and field, Levels.fyi medians for industry, NSF/NIH funding levels for the start-up.
...
1. **Verbal offer** — usually from the chair or hiring manager. Express enthusiasm, ask for time to consider, request the offer in writing. Do not negotiate details over the phone; say "I would like to see the offer in writing before discussing specifics".
2. **Written offer letter** — the official terms. Read every line. Note: salary, start-up, tenure-track status, start date, probationary period, summer salary, moving allowance, partner accommodation, conditions of employment.
3. **Counter-offer** — your written response. Always written; phone calls are not the right medium for the counter.
4. **Verbal conversation to discuss the counter** — the chair and dean will want to talk through your asks. Use this to clarify, prioritize, and find trade-offs.
5. **Revised written offer** — the institution's response in writing. Read carefully; some institutions will write down "we have increased the start-up by $X" and leave the rest unchanged. Confirm the total package.
6. **Acceptance or decline** — written, signed, and dated.
...
1. **Raise it early in the search, not after the offer.** "I have a partner in [field]; what does your institution offer for dual-career support?" If HR is silent or negative, that is a signal about the institution.
2. **Bring the partner's CV and research area to the conversation.** A specific, credible partner profile is much easier to support than a vague "my partner is also a researcher".
3. **Know the options**: spousal hire (a tenure-track line), spousal adjunct (one-year renewable, often teaching-only), visiting scholar, dual-career office assistance (resume review, networking), partner relocation support, partner-hire funding from the provost.
4. **Negotiate as a package, not a separate item.** "I would like a $200k spousal-hire line for my partner" is a clean ask. "Could you find my partner a job?" is not.
5. **Get it in writing.** The institution should put the dual-career commitment in a separate memo or in the offer letter.
...
- `ors-career-navigation-faculty-interview` — the academic offer and start-up package context
- `ors-career-navigation-industry-transition` — the industry offer context
- `ors-career-navigation-tenure-dossier` — long-term package implications for academic offers
- `ors-career-navigation-academic-cv` — CV used in the negotiation context
- `ors-research-grants-nsf-standard` — funding strategy referenced in the start-up ask
- `ors-mentorship-teaching-ors-mentorship-onboarding` — for the mentoring / dual-career components
