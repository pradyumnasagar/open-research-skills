---
name: ors-literature-research-citation-management
display_name: "Citation and Reference Management"
...
tags: [zotero, mendeley, bibtex, citation-style, doi, reference-manager]
difficulty: beginner
prerequisites:
  tools: [Zotero 6+, ZotFile/Zotero PDF Translate, Better BibTeX, RStudio/VSCode (optional)]
  skills: []
sources_consulted:
  - "Zotero documentation and community guides (zotero.org/support); Adapted: Integration with literature research workflow"
  - "Citation Style Language specification (citationstyles.org); Adapted: Format examples and CSL editing"
  - "Better BibTeX for Zotero (retorque.re/zotero-better-bibtex); Adapted: Modern export patterns"
  - "DOI resolution via doi.org and Crossref (crossref.org); Adapted: Programmatic DOI workflows"
  - "APA 7th Edition Style Guide, Vancouver Style guidelines; Adapted: Modern format examples"
