---
name: ors-literature-research-paper-lookup
display_name: "Paper Lookup and Resolution"
...
tags: [doi, pmid, crossref, pubmed, retraction-watch, openalex]
difficulty: beginner
prerequisites:
  tools: [python, requests, biopython (optional)]
  skills: []
sources_consulted:
  - "Crossref API documentation (api.crossref.org); Adapted: DOI resolution and metadata"
  - "NCBI E-utilities (eutils.ncbi.nlm.nih.gov); Adapted: PMID and PMC ID handling"
  - "OpenAlex API (docs.openalex.org); Adapted: Open scholarly metadata"
  - "Semantic Scholar API (api.semanticscholar.org); Adapted: Citation graph and recommendations"
  - "Retraction Watch database (retractionwatch.com); Adapted: Retraction status checking"
  - "arXiv API (arxiv.org/help/api); Adapted: Preprint lookup"
  - "ORCID (orcid.org); Adapted: Author disambiguation"
