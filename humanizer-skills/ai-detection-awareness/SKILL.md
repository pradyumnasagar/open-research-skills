---
name: ors-humanizer-skills-ai-detection-awareness
display_name: "AI Detection Awareness"
...
tags: [ai-detection, perplexity, burstiness, integrity, paraphrasing, process-based-assessment]
...
sources_consulted:
  - "Original: public statements and product pages from GPTZero, Turnitin, Copyleaks, Originality.ai, Pangram — Adapted: structural summary; specific accuracy claims not repeated, verify in current vendor documentation"
  - "Original: university teaching-and-learning center guidance on AI detection (representative institutions) — Adapted: structural summary of common themes, verify in current institutional guidance"
  - "Improvisions: false-positive analysis by population, paraphrase-tool failure mode, process-based assessment as the institutional response"
