---
name: ors-chemoinformatics-similarity-searching
...
primary_tool: RDKit
sources_consulted:
  - bioSkills-main/chemoinformatics/similarity-searching/SKILL.md
...
Reference examples tested with: RDKit 2024.09+, scikit-learn 1.4+, annoy 1.17+, mhfp 1.9+, molfeat 0.10+.
...
| Pluggable featurization for benchmarks | molfeat transformer factory | molfeat |
...
- Bajorath, *Nat. Rev. Drug Discov.* 1:882 -- molecular similarity principle review.
- Maggiora et al., *J. Med. Chem.* 57:3186 -- molecular similarity in drug discovery.
- Stumpfe & Bajorath, *J. Med. Chem.* 55:2932 -- activity cliffs.
- Tversky, *Psychol. Rev.* 84:327 -- features of similarity (Tversky coefficient).
- Probst & Reymond, *J. Cheminformatics* 10:66 -- MHFP6 MinHash fingerprint.
- O'Boyle et al., *J. Cheminformatics* 8:36 -- comparing fingerprints for similarity.
- Butina, *J. Chem. Inf. Comput. Sci.* 39:747 -- Taylor-Butina clustering.
