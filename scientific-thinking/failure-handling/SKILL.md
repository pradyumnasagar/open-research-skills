---
name: ors-scientific-thinking-failure-handling
display_name: "Failure Handling"
...
tags: [negative-results, replication, preregistration, hypothesis-revision, scientific-integrity]
difficulty: intermediate
prerequisites:
  tools: []
  skills: [ors-scientific-thinking-critical-thinking, ors-scientific-thinking-hypothesis-generation]
sources_consulted:
  ...
  - "Errington, T.M. et al.. Reproducibility in Cancer Biology: Challenges for assessing replicability"
  - "Chambers, C.D. et al.. Registered Reports - Realigning incentives in scientific publishing"
