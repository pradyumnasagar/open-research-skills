---
name: ors-image-analysis-microscopy-image-analysis-best-practices
display_name: "Image Analysis Best Practices: Acquisition, Controls, and Publication"
...
tags: [image-analysis, best-practices, controls, publication, statistics, color-blind]
difficulty: intermediate
prerequisites:
  tools: [python>=3.10, imageio, numpy, scipy, matplotlib]
  skills: []
sources_consulted:
  - "Original: Rossner & Yamada 2004 JCB editorial 'What's in a picture?'; Adapted: 2026 image-ethics framing, modernized to current ARRIVE 2.0 and NIH figure guidelines."
  - "Improvisions: consolidated exposure, scale-bar, and color-blind guidance; added hierarchical-statistics section referencing the n=cells vs n=images vs n=animals debate."
