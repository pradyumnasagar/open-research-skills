---
name: ors-image-analysis-microscopy-qupath-pathology
display_name: "QuPath for Digital Pathology and Whole-Slide Image Analysis"
...
tags: [qupath, digital-pathology, whole-slide, cell-detection, pixel-classification, stardist, cellpose]
difficulty: intermediate
prerequisites:
  tools: [qupath>=0.5, java>=17, jdk>=17]
  skills: []
sources_consulted:
  - "Original: QuPath documentation (qupath.readthedocs.io); Adapted: 2026 QuPath 0.5.x features, modernized StarDist/Cellpose extension install notes."
  - "Improvisions: added TMA workflow pointers, multiplexed analysis notes (e.g. OME-TIFF multi-channel), and JUPYTER-via-QuPath section."
