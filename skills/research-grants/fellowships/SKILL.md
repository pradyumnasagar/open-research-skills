...
| Fellowship | Open | Close | Decision | Notes |
|------------|------|-------|----------|-------|
| NSF GRFP | Aug (cycle) | Oct (cycle) | Apr | Two applications: Personal + Research |
| Hertz | Aug | Oct | Feb | One proposal, one personal essay |
| NDSEG | Aug | Oct | Feb | DoD focus; online submission |
| Ford | Aug | Jan | Apr | Advisor letter required |
| Rhodes | Aug | Oct (varies by country) | Nov | Citizenship-specific; institutional endorsement |
| Marshall | Aug | Oct | Nov | Institutional endorsement required |
| Churchill | Aug | Oct | Dec | STEM focus |
| AAAS STPF | Jan | May | Oct | For PhDs and engineers; policy-focused |

### Graduate school list template

| School | Program | Faculty of interest | Why this program | Application deadline | Notes |
|--------|---------|---------------------|------------------|---------------------|-------|
...
- NSF: [Graduate Research Fellowship Program (GRFP)](https://www.nsfgrfp.org/) — program information, solicitation, and submission portal.
- Hertz Foundation: [Hertz Graduate Fellowship](https://www.hertzfoundation.org/) — application and rubric.
- DoD: [NDSEG Fellowship](https://www.ndseg.org/) — program description, eligibility, and submission.
- National Academies: [Ford Foundation Fellowship](https://sites.nationalacademies.org/pga/fordfellowships/) — predoctoral, dissertation, and postdoctoral programs.
- Rhodes Trust: [Rhodes Scholarship](https://www.rhodeshouse.ox.ac.uk/scholarships) — application by country of citizenship.
- Marshall Aid Commemoration Commission: [Marshall Scholarship](https://www.marshallscholarship.org/).
- Winston Churchill Foundation: [Churchill Scholarship](https://www.churchillscholarship.org/).
- AAAS: [Science & Technology Policy Fellowship (STPF)](https://www.aaas.org/programs/science-technology-policy-fellowships).
- US/UK graduate school lists: [US PhD programs (NSF GRFP)](https://www.nsfgrfp.org/) — list of US-based graduate programs.
