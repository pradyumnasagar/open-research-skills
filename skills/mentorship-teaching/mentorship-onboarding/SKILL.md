...
description: "Establishes effective mentor-mentee relationships through structured
  onboarding using the Entering Mentoring curriculum (CIMER, UW-Madison), defining
  expectations, communication cadences, and feedback norms. Use when initiating a
  new mentoring relationship, transitioning between mentors, or formalizing an informal
  mentorship.
license: MIT
---
...
"Before we set goals, I'd like to understand where you are in each of these areas. On a scale of 1-5 for each: Where would you rate yourself, and what's one area where you'd most like to grow?"
...
**Impact:** "It [positive/neutral/negative effect]..."
**Suggestion:** "In the future, consider [alternative]..."

**Example:**
"当你在实验前检查protocols时，你的实验成功率和可重复性显著提高。建议继续保持这个习惯，也尝试在开始前向团队成员简要解释你的实验设计。"
