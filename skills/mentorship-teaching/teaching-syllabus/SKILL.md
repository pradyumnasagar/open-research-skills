...
**Apply-level outcome:**"
"By the end of this course, students will be able to **implement** [technique] in [software] to [purpose]."

**Analyze-level outcome:**
"By the end of this course, students will be able to **compare and contrast** [method 1] and [method 2] for [problem] and **diagnose** when each is appropriate."

**Create-level outcome:**
"By the end of this course, students will be able to **design** a [artifact type] that [addresses need] and **justify** design choices with [evidence type]."
