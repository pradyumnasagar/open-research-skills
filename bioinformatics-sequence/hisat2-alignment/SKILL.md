---
name: ors-bioinformatics-sequence-hisat2-alignment
display_name: "HISAT2 RNA-seq Alignment"
...
tags: [hisat2, rna-seq, splice, alignment, illumina]
difficulty: intermediate
prerequisites:
  tools: [hisat2>=2.2, samtools>=1.19]
  skills: [ors-bioinformatics-sequence-fastp-workflow]
sources_consulted:
  - "Original: bio-hisat2-alignment (bioSkills-main/read-alignment/hisat2-alignment); Adapted: 2026 HISAT2 2.2.x, added known-splice-site index, graph-based index guidance."
