---
name: ors-bioinformatics-sequence-bwa-mem2-alignment
display_name: "BWA-MEM2 — Faster BWA-MEM"
...
tags: [bwa-mem2, bwa, alignment, illumina, performance, simd]
difficulty: intermediate
prerequisites:
  tools: [bwa-mem2>=2.2.1, samtools>=1.19]
  skills: [ors-bioinformatics-sequence-bwa-alignment]
sources_consulted:
  - "Original: SciAgent-Skills genomics-bioinformatics/alignment/bwa-mem2-dna-aligner; Adapted: modernized to BWA-MEM2 2.2.1, 2026 best practices, swapped flags for variant-calling readiness."
  - "Improvisions: added gap-skill context — BWA-MEM2 is the gap-filler for production speed-critical pipelines."
