---
name: ors-bioinformatics-sequence-sequence-statistics
...
tags: [biopython, n50, l50, gc, fastq, fasta, stats]
difficulty: beginner
prerequisites:
  tools: [python>=3.10, biopython>=1.83, numpy, polars]
  skills: []
sources_consulted:
  - "Original: bio-sequence-statistics (bioSkills-main/sequence-io/sequence-statistics); Adapted: added N50/L50 derivation, 2026 Bio.SeqUtils API notes, polars/pydantic modern output."
  - "Improvisions: included assembly-aware stats (N50, L50, auN) for contig-level reporting."
