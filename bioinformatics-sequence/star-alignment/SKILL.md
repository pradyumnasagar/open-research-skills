---
name: ors-bioinformatics-sequence-star-alignment
display_name: "STAR RNA-seq Alignment"
...
tags: [star, rna-seq, splice, alignment, illumina, junction]
difficulty: advanced
prerequisites:
  tools: [star>=2.7.11, samtools>=1.19]
  skills: [ors-bioinformatics-sequence-fastp-workflow]
sources_consulted:
  - "Original: bio-star-alignment (bioSkills-main/read-alignment/star-alignment); Adapted: 2026 STAR 2.7.11+ flag updates, added 2-pass mapping strategy, modern RAM guidance."
  - "Improvisions: added cloud-friendly streaming notes, splice junction database access."
