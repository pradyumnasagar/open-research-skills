---
name: ors-bioinformatics-sequence-format-conversion
display_name: "Sequence Format Conversion (FASTA / GenBank / EMBL / FASTQ / GFF)"
...
tags: [biopython, seqio, fasta, genbank, embl, fastq, conversion]
difficulty: beginner
prerequisites:
  tools: [python>=3.10, biopython>=1.83]
  skills: []
sources_consulted:
  - "Original: bio-format-conversion (bioSkills-main/sequence-io/format-conversion); Adapted: pruned the 'convert' pitfalls, added 2026-era notes on round-trip-safe formats and seqkit open alternative."
  - "Improvisions: new lossless-vs-lossy table, recommendations for EMBL → GenBank via UniParc."
