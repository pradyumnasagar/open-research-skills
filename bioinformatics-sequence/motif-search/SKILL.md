---
name: ors-bioinformatics-sequence-motif-search
display_name: "Motif and Pattern Search"
...
tags: [biopython, regex, motif, pwm, jaspar, binding-site]
difficulty: intermediate
prerequisites:
  tools: [python>=3.10, biopython>=1.83, regex>=2024.5]
  skills: [ors-bioinformatics-sequence-seq-objects]
sources_consulted:
  - "Original: bio-motif-search (bioSkills-main/sequence-manipulation/motif-search); Adapted: Bio.motifs 2026 status, added JASPAR 2024 fetch, modern alternative is pyjaspar."
  - "Improvisions: added position weight matrix scanning, de novo motif discovery pointer (MEME, STREME)."
