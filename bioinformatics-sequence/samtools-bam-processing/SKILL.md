---
name: ors-bioinformatics-sequence-samtools-bam-processing
display_name: "samtools BAM Processing"
...
tags: [samtools, bam, sam, sorting, indexing, markdup]
difficulty: intermediate
prerequisites:
  tools: [samtools>=1.19, bcftools>=1.19]
  skills: [ors-bioinformatics-sequence-sam-bam-basics]
sources_consulted:
  - "Original: bio-samtools-bam-processing (SciAgent-Skills genomics-bioinformatics/alignment/samtools-bam-processing); Adapted: modernized to samtools 1.19+ pipeline, added correct BAM processing workflow."
  - "Improvisions: added the canonical alignment → sort → fixmate → markdup → sort → index workflow."
